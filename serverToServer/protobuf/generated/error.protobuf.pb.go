...
/*
	Package s2sProtobuf is a generated protocol buffer package.
...
type Error struct {
	...
	Type        ErrorType `protobuf:"varint,2,opt,name=Type,json=type,proto3,enum=s2sProtobuf.ErrorType" json:"Type,omitempty"`
...
func init() {
	proto.RegisterType((*Error)(nil), "s2sProtobuf.Error")
	proto.RegisterEnum("s2sProtobuf.ErrorType", ErrorType_name, ErrorType_value)
}
...
var fileDescriptorErrorbuf = []byte{
	...
	0x2f, 0xd2, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x4f, 0x2a, 0x4d, 0x13, 0xe2, 0x2e, 0x36, 0x2a, 0x0e,
	...
	0xc6, 0x63, 0x39, 0x86, 0x24, 0x36, 0xb0, 0xe3, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xbd,
	0x36, 0xba, 0x8f, 0xcb, 0x00, 0x00, 0x00,
}
